...
// TODO: TUMI IMPORTS FOR CATEGORIES 
import { CarsComponent } from './collection/cars/cars.component';
import { YachtsComponent } from './collection/yachts/yachts.component';
import { JewelleryComponent } from './collection/jewellery/jewellery.component';
import { AircraftsComponent } from './collection/aircrafts/aircrafts.component';

// TODO: TUMI IMPORTS FOR VIEW PAGES 
import {UsedCarComponent} from './product/sidebar/used-car/used-car.component'
...
const routes: Routes = [
  {
    path: 'product/used-car/:slug',
    component: UsedCarComponent,
    resolve: {
      data: Resolver
    }
  },
  { path: 'collection/cars',
    component: CarsComponent
  },
  { path: 'collection/yachts',
    component: YachtsComponent
  },
  { path: 'collection/aircrafts',
