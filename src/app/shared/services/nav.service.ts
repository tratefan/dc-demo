...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			path: '/home/furniture', title: 'home', type: 'link',
		},
		{
			path: '/home/furniture', title: 'About', type: 'link',
		},
		{
			title: 'Cars', type: 'sub', active: false, children: [
				{
					title: 'Used Cars', type: 'sub', active: false, children: [
						{ path: '/shop/product/no/sidebar', title: 'View All', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Audi', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Volkswagen', type: 'link' }
					]
				},
				{
					title: 'Dream Cars', type: 'sub', active: false, children: [
						{ path: '/shop/product/no/sidebar', title: 'View All', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Audi', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Volkswagen', type: 'link' }
					]
				},
				{ path: '/shop/product/no/sidebar', title: 'Book A Test Drive', type: 'link' },
			]
		},
		{
			title: 'Aircrafts', type: 'sub', active: false, children: [
				{ path: '/shop/product/no/sidebar', title: 'View All', type: 'link' },
				{
					...
					title: 'Fleet Category', type: 'sub', active: false, children: [
						{ path: '/shop/product/no/sidebar', title: 'Beechcraft', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Bombardier', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'British Aerospace', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Cessna', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Gulfstream', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Helicopters', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Nextant', type: 'link' },
						{ path: '/shop/product/no/sidebar', title: 'Pilatus', type: 'link' }
					]
				}
			]
		},
		{
			path: '/home/furniture', title: 'Yatchts', type: 'link',
		},
		{
			path: '/home/furniture', title: 'Jewellery', type: 'link',
		},
	];

	LEFTMENUITEMS: Menu[] = [
		{
			title: 'boos', type: 'sub', megaMenu: true, active: false, children: [
				{
